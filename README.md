...
The transcript now includes timestamps (for example `[00:10:05]`) for each line.
Summaries generated by the app reference these timestamps so you can quickly
locate the relevant section in the original media.
